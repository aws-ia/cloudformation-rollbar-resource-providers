...
1. Write the JSON schema describing your resource, [rollbar-projects-accesstoken.json](./rollbar-projects-accesstoken.json)
2. Implement your resource handlers in [handlers.ts](./rollbar-projects-accesstoken/handlers.ts)

> Don't modify [models.ts](./rollbar-projects-accesstoken/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
