...
1. Write the JSON schema describing your resource, [rollbar-teams-team.json](./rollbar-teams-team.json)
2. Implement your resource handlers in [handlers.ts](./rollbar-teams-team/handlers.ts)

> Don't modify [models.ts](./rollbar-teams-team/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
