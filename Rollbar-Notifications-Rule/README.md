...
1. Write the JSON schema describing your resource, [rollbar-notifications-rule.json](./rollbar-notifications-rule.json)
2. Implement your resource handlers in [handlers.ts](./rollbar-notifications-rule/handlers.ts)

> Don't modify [models.ts](./rollbar-notifications-rule/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
