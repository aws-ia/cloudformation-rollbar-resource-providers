...
1. Write the JSON schema describing your resource, [rollbar-projects-project.json](./rollbar-projects-project.json)
2. Implement your resource handlers in [handlers.ts](./rollbar-projects-project/handlers.ts)

> Don't modify [models.ts](./rollbar-projects-project/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
