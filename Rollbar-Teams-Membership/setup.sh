...
cat test/integ-template.yml | sed "s/ROLLBAR_TEAMSMEMBERSHIP_TEAM_ID/${ROLLBAR_TEAMSMEMBERSHIP_TEAM_ID}/g" | sed "s/ROLLBAR_TEAMSMEMBERSHIP_MEMBER_ID/${ROLLBAR_TEAMSMEMBERSHIP_MEMBER_ID}/g" > test/integ.yml