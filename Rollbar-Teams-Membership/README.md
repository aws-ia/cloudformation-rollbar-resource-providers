...
1. Write the JSON schema describing your resource, [rollbar-teams-membership.json](./rollbar-teams-membership.json)
2. Implement your resource handlers in [handlers.ts](./rollbar-teams-membership/handlers.ts)

> Don't modify [models.ts](./rollbar-teams-membership/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
